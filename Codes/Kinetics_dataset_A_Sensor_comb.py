...
main_dir = "/home/sanzidpr/JBHI_revision/Sensor_combination_3/Subject16"
os.mkdir(main_dir) 
path="/home/sanzidpr/JBHI_revision/Sensor_combination_3/Subject16/"
subject='Subject_16'
hf = h5py.File('/home/sanzidpr/Public Kinetics dataset/Subject_16_data.h5', 'r')
...
def Results_output(sensor_number,Features,sensor,train_X_1D,train_X_2D,X_validation_1D,X_validation_2D,test_X_1D,test_X_2D):
  ...
  history=model_1.fit([train_X_1D,train_X_2D], [train_y_5,train_y_5,train_y_5,train_y_5], epochs=45, batch_size=64, validation_data=([X_validation_1D,X_validation_2D], \
  ...
  history=model_2.fit([train_X_1D,train_X_2D], [train_y_5,train_y_5,train_y_5,train_y_5], epochs=60, batch_size=64, validation_data=([X_validation_1D,X_validation_2D],\
                                                                                          [Y_validation,Y_validation,Y_validation,Y_validation]), verbose=2, shuffle=True,callbacks=[custom_early_stopping])
...
RMSE_Kinetics_FM_DLR_7, PCC_Kinetics_FM_DLR_7=Results_output('7',18,3,train_X_1D,train_X_2D,X_validation_1D,\
                                                         X_validation_2D,test_X_1D,test_X_2D)
...
ablation_7=np.hstack([RMSE_Kinetics_FM_DLR_7, PCC_Kinetics_FM_DLR_7])

"""## Result Summary"""

#All_result=np.vstack([ablation_1,ablation_2,ablation_3,ablation_4,ablation_5,ablation_6])

#All_result=np.vstack([ablation_4,ablation_5])

from numpy import savetxt

savetxt(path+subject+'_Sensor_combination_results_2.csv', ablation_7, delimiter=',')