...
main_dir = "/home/sanzidpr/JBHI_revision/Dataset 2/Bagging/Subject09"
#os.mkdir(main_dir) 
path="/home/sanzidpr/JBHI_revision/Dataset 2/Bagging/Subject09/"
subject='Subject_09'
...
test_o=test_y.reshape((s,5))
plot=np.hstack([test_o,yhat_10])


#
#rmse_bag_1,p_bag_1,Z_1,Z_2,Z_3,Z_4,Z_5=RMSE_prediction(yhat_1,test_y,s)
#rmse_bag_2,p_bag_2,Z_1,Z_2,Z_3,Z_4,Z_5=RMSE_prediction(yhat_2,test_y,s)
#rmse_bag_3,p_bag_3,Z_1,Z_2,Z_3,Z_4,Z_5=RMSE_prediction(yhat_3,test_y,s)
#rmse_bag_4,p_bag_4,Z_1,Z_2,Z_3,Z_4,Z_5=RMSE_prediction(yhat_4,test_y,s)
#rmse_bag_5,p_bag_5,Z_1,Z_2,Z_3,Z_4,Z_5=RMSE_prediction(yhat_5,test_y,s)
#rmse_bag_6,p_bag_6,Z_1,Z_2,Z_3,Z_4,Z_5=RMSE_prediction(yhat_6,test_y,s)
#rmse_bag_7,p_bag_7,Z_1,Z_2,Z_3,Z_4,Z_5=RMSE_prediction(yhat_7,test_y,s)
#rmse_bag_8,p_bag_8,Z_1,Z_2,Z_3,Z_4,Z_5=RMSE_prediction(yhat_8,test_y,s)
#rmse_bag_9,p_bag_9,Z_1,Z_2,Z_3,Z_4,Z_5=RMSE_prediction(yhat_9,test_y,s)
#rmse_bag_10,p_bag_10,Z_1,Z_2,Z_3,Z_4,Z_5=RMSE_prediction(yhat_10,test_y,s)
#
#
...
savetxt(path+'Plot_KAM_KFM.csv', plot, delimiter=',')
