...
train_dataset_treadmill=np.concatenate((subject_7_treadmill,subject_8_treadmill,subject_9_treadmill,subject_10_treadmill,subject_11_treadmill,subject_12_treadmill,
                              ...
                              subject_23_treadmill,subject_24_treadmill,subject_25_treadmill,subject_27_treadmill,subject_28_treadmill),axis=0)
...
train_dataset_levelground=np.concatenate((subject_7_levelground,subject_8_levelground,subject_9_levelground,subject_10_levelground,subject_11_levelground,subject_12_levelground,
                              ...
                              subject_23_levelground,subject_24_levelground,subject_25_levelground,subject_27_levelground,subject_28_levelground),axis=0)
...
train_dataset_ramp=np.concatenate((subject_7_ramp,subject_8_ramp,subject_9_ramp,subject_10_ramp,subject_11_ramp,subject_12_ramp,
                              ...
                              subject_23_ramp,subject_24_ramp,subject_25_ramp,subject_27_ramp,subject_28_ramp),axis=0)
...
train_dataset_stair=np.concatenate((subject_7_stair,subject_8_stair,subject_9_stair,subject_10_stair,subject_11_stair,subject_12_stair,
                              ...
                              subject_23_stair,subject_24_stair,subject_25_stair,subject_27_stair,subject_28_stair),axis=0)
...
test_dataset=np.concatenate((subject_30_treadmill,subject_30_levelground,subject_30_ramp,subject_30_stair),axis=0)


import os 
 
main_dir = "/home/sanzidpr/GRF_JM_SOTA_1/Subject30"
os.mkdir(main_dir) 

path='/home/sanzidpr/GRF_JM_SOTA_1/Subject30/'
