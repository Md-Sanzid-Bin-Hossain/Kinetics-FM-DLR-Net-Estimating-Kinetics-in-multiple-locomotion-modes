...
main_dir = "/home/sanzidpr/JBHI_revision/Dataset 2/Model Ablation/Subject04"
os.mkdir(main_dir) 
path="/home/sanzidpr/JBHI_revision/Dataset 2/Model Ablation/Subject04/"
subject='Subject_04'
...
history=model_1.fit([train_X_1D,train_X_2D], train_y_5, epochs=40, batch_size=64, validation_data=([X_validation_1D,X_validation_2D], Y_validation), verbose=2, shuffle=False, callbacks=[custom_early_stopping])
...
history=model_2.fit([train_X_1D,train_X_2D], train_y_5, epochs=40, batch_size=64, validation_data=([X_validation_1D,X_validation_2D], Y_validation), verbose=2, shuffle=False,callbacks=[custom_early_stopping])
...
history=model_3.fit([train_X_1D,train_X_2D], train_y_5, epochs=40, batch_size=64, validation_data=([X_validation_1D,X_validation_2D], Y_validation), verbose=2, shuffle=False,callbacks=[custom_early_stopping])
...
history=model_1.fit([train_X_1D,train_X_2D], [train_y_5,train_y_5,train_y_5], epochs=40, batch_size=64, validation_data=([X_validation_1D,X_validation_2D], \
                                                                                          [Y_validation,Y_validation,Y_validation]), verbose=2, shuffle=False,callbacks=[custom_early_stopping])
