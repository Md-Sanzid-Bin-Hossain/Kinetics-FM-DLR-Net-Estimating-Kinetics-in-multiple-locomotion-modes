...
main_dir = "/home/sanzidpr/JBHI_revision/Model_ablation_3_dataset_1/Subject30"
os.mkdir(main_dir) 
path="/home/sanzidpr/JBHI_revision/Model_ablation_3_dataset_1/Subject30/"
subject='Subject_30'
...
history=model_2.fit([train_X_1D,train_X_2D], train_y_5, epochs=50, batch_size=64, validation_data=([X_validation_1D,X_validation_2D], Y_validation), verbose=2, shuffle=False,callbacks=[custom_early_stopping])
